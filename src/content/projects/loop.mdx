...
<Gallery images={[
  ...
  { src: '/projects/loop/dashboard.png', alt: 'Up to date dashboard with easy access to events and friends' },
  { src: '/projects/loop/chat.png', alt: 'AI assistant proposing a time that works for the group' },
]} />
